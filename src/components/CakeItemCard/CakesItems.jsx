        ...
        <>
            {products.products && products.products.map((val, i) =>
                <SingleCakeItem
                    ...
                    sellingprice={val.product_variants && val.product_variants[0] && val.product_variants[0].list_price}
                    originalprice={val.product_variants && val.product_variants[0] && val.product_variants[0].mrp}
